...
namespace MiniORM
{
        ...
        where T : class, new()
    {
        ...
        public IEnumerable<T> GetModifiedEntities(DbSet<T> dbSet)
        {
            ...
            {
                var primaryKeyValues = GetPrimaryKetValues(primaryKeys, proxyEntity).ToArray();

                var entity = dbSet.Entities
                    .Single(e => GetPrimaryKetValues(primaryKeys, e).SequenceEqual(primaryKeyValues));
        ...
        private static IEnumerable<object> GetPrimaryKetValues(IEnumerable<PropertyInfo> primaryKeys, T entity)
        {
